...
export const routes: Routes = [
  { path: 'avaliar', loadComponent: () => import('./avaliacao/review-page.component').then(m => m.ReviewPageComponent) },
  { path: 'avaliacoes', canActivate: [authGuard], loadComponent: () => import('./avaliacao/review-owner.component').then(m => m.ReviewOwnerComponent) },
