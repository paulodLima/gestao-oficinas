...
@Component({
  ...
  `,
  styles: `
    :host button, :host input:not([type=checkbox]), :host select, :host summary, :host .photo-options label { min-height:44px }
    :host summary { display:flex; align-items:center }
